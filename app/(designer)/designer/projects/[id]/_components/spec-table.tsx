    ...
    <div className={cn(pending && "opacity-70 transition-opacity")}>
      ...
      <div className="hidden overflow-x-auto sm:block">
        <table className="w-full min-w-[680px] text-left text-sm">
          <thead>
            <tr className="border-b border-line font-mono text-[13.75px] uppercase tracking-[.05em] text-mut">
    ...
    <>
      <tr className="border-b border-line">
        ...
        {canManage ? (
          <>
            <td className="px-2 py-1.5">
              <input
                ...
                className={cn(cell, "font-mono text-[15.625px] font-medium text-ink")}
            ...
            <td className="px-2 py-1.5">
              <div className="flex items-center gap-1">
                <input defaultValue={item.qty} onBlur={commitQty} inputMode="decimal" className={cn(cell, "w-20 font-mono text-[15.625px]")} aria-label={t("colQty")} />
          ...
          <>
            <td className="px-4 py-2.5"><span className="rounded-[6px] border border-line bg-canvas px-[9px] py-[4px] font-mono text-[15px] text-sub">{item.code}</span></td>
  ...
  return (
    <td
      className={cn(
        ...
        isPrice && "font-mono text-[15.625px] font-semibold",
