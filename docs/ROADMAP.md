...
- [ ] **1.1 CRUD โปรเจกต์ + หลายโปรเจกต์** — list, สร้าง, duplicate, archive
  - AC: สร้าง/เปิด/ลบได้ · ข้อมูลอยู่ใน DB (รีเฟรชไม่หาย) · duplicate คัดลอกโครง
- [ ] **1.2 ตารางสเปก + แก้ inline** — code/zone/qty แก้ได้ · เพิ่ม/ลบแถว · sort
  - AC: แก้แล้วบันทึกจริง · รหัสแก้อิสระ · มี audit log
- [ ] **1.3 หลายตัวเลือกต่อรายการ (SpecOption)** — เก็บ option, confirm, ตัดทิ้ง
  - AC: 1 รายการมีได้ ≤4 ตัวเลือก · confirm แล้วสถานะเปลี่ยน · logic สถานะมี test
- [ ] **1.4 คลังวัสดุ + ค้นหา + filter หมวด** — จากหน้าเลือกหมวดก่อน → คลัง
